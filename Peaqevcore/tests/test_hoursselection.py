import pytest
from peaqevcore.hoursselection import Hoursselectionbase as h
from peaqevcore.Models import (CAUTIONHOURTYPE_AGGRESSIVE, CAUTIONHOURTYPE_INTERMEDIATE, CAUTIONHOURTYPE_SUAVE, CAUTIONHOURTYPE)
